    ...
    <section id='product' className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
            ...
            <p className={`${styles.paragraph}`}>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel temporibus sapiente assumenda dicta unde fuga quaerat nisi hic quidem corporis!
            </p>

            <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
                <img src={apple} alt='apple-store' className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>
                <img src={google} alt='google-store' className='w-[128px] h-[42px] object-contain mr5 cursor-pointer'/>
            </div>
        </div>
